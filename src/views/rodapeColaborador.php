        ...
        <footer class="rodape">
            <div class="container">
                <div class="row footer-bottom d-flex justify-content-between align-items-center"">
                    ...
                    <strong>Inovacon</strong> - Inovação em Primeiro lugar&copy;<script>document.write(new Date().getFullYear());</script>
                    </p>
        ...
        <link rel="stylesheet" href="src/assets/js/personalizado.js">
    </body>
</html>
